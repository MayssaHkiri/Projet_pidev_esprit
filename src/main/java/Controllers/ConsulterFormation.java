...
public class ConsulterFormation implements Initializable {
    ...
    private StackPane createFormationPane(Formation formation) {
        ...
        stackPane.setMaxWidth(Double.MAX_VALUE); // Ensure StackPane takes available width
        stackPane.setMaxHeight(Double.MAX_VALUE); // Ensure StackPane takes available height
        try {
